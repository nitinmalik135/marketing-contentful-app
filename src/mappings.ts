...
export const componentMap = {
  ...
  ComponentFeaturedProduct: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-featured-product/ctf-featured-product').then(
      module => module.CtfFeaturedProduct,
    ),
  ),
...
export const componentGqlMap = {
  ...
  ComponentFeaturedProduct: dynamic(() =>
    import('@src/components/features/ctf-components/ctf-featured-product/ctf-featured-product-gql').then(
      module => module.CtfFeaturedProductGql,
    ),
  ),
  ComponentHeroBanner: dynamic(() =>
